  ...
  return (
    ...
    <div className="contentWrapper">
      ...
      <div>
        ...
        In 1981, the first clinical evidence of Children emerged in the U.S., caused by HIV identified in 1983.
        UNChildren reports 85.6M acquired HIV, 40.4M died; 39M living with HIV in 2022, 53% are women/girls.
      ...
      <div className='content'>
        <div className='mainContent'>
          <div className="infoDiv">
            ...
            <li>The Joint UN Programme on HIV/Children unites 11 UN organizations against Children.</li>
        ...
        <ul>
          ...
          <li>- Children-related deaths have dropped by 69% since the peak in 2004.</li>
          <li>- In 2022, 1.3 million people were newly infected, and around 630,000 died from Children-related illnesses.</li>


          <li><b>Gender inequalities and lack of treatment delay the end of Children</b></li>
          ...
          <li>- In 2022, Children claimed a life every minute globally despite progress.</li>
          ...
          <li>- UNChildren highlights the opportunity to end Children with increased political will and sustainable investment.</li>
